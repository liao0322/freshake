...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:[Single sharedInstance].isRefreshTitle ? @"拖动查看图文详情" : MJRefreshAutoFooterIdleText forState:MJRefreshStateIdle];
    ...
    if ([Single sharedInstance].isRefreshTitle) {
        self.stateLabel.textColor = [UIColor colorWithHexString:@"0x999999"];
    }
    else self.stateLabel.textColor = [UIColor blackColor];
