...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.progressView.progressTintColor    = [UIColor colorWithWhite:1.000 alpha:0.300];
...
-(void)layoutSubviews
{
    ...
    self.volumeProgress.bounds = CGRectMake(0, 0,80,30);
    self.volumeProgress.center = CGPointMake(25 ,height/2 - 25);
}
