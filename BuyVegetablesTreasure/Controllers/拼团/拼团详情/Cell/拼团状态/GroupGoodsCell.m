...
- (void)initCell {
    ...
    _goodsTitleLabel.textColor = [UIColor colorWithHexString:@"0x606060"];
    ...
    _goodsNumLabel.textColor = [UIColor colorWithHexString:@"0x606060"];
    _goodsNumLabel.text = @"5人团  ¥9.9元／份";
    _goodsNumLabel.font = [UIFont systemFontOfSize:13];
    [self.contentView addSubview:_goodsNumLabel];
    
    _isSuccessImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"拼团成功图标"]];
    _isSuccessImageView.frame = CGRectMake(ScreenWidth - 80, 18, 64, 64);
...
- (void)setGroupModel:(MyGroupModel *)model {
    ...
    [_isSuccessImageView setImage:[model.IsPay boolValue] ? IMAGE(@"已支付-圆") : IMAGE(@"待支付-圆")];
