...
-(void)initTview{
    ...
    [attributeString setAttributes:@{NSForegroundColorAttributeName : [UIColor colorWithHexString:@"0xff6600"],   NSFontAttributeName : [UIFont systemFontOfSize:16]} range:NSMakeRange(24, 9)];
